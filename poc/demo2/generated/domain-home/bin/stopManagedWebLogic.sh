...
usage()
{
	...
	echo "ADMIN_URL defaults to t3://tmoreau-mac.local:7100 if not set as an environment variable or the second command-line parameter."
	...
	echo "for example:"
	echo "$1 managedserver1 t3://tmoreau-mac.local:7100 weblogic weblogic"
}

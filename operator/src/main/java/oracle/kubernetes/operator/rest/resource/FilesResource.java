...
/**
 * FilesResource is a jaxrs resource that implements the REST api for the
 * /operator/{version}/files path. It can be used to download files
 * from the operator.
 */
public class FilesResource extends BaseResource {
   ...
   * 
   * @param parent
   *          - the jaxrs resource that parents this resource.
   * @param pathSegment
   *          - the last path segment in the url to this resource.
   */

...
public class ClusteredServerConfig extends ServerConfig
{
   ...
   * Legal values are ALWAYS, IF_NEEDED and NEVER.
   ...
   */
  @Override
  public ClusteredServerConfig withGracefulShutdownIgnoreSessions(boolean gracefulShutdownIgnoreSessions) {
   ...
   */
  @Override
  public ClusteredServerConfig withGracefulShutdownWaitForSessions(boolean gracefulShutdownWaitForSessions) {

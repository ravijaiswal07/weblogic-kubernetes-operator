...
public class NonClusteredServerConfig extends ServerConfig
{
   ...
   * @return this
   */
  public NonClusteredServerConfig withNonClusteredServerStartPolicy(String nonClusteredServerStartPolicy) {
    this.nonClusteredServerStartPolicy = nonClusteredServerStartPolicy;
    return this;
  }
   ...
   */
  @Override
  public NonClusteredServerConfig withImagePullSecrets(List<V1LocalObjectReference> imagePullSecrets) {
   ...
   */
  @Override
  public NonClusteredServerConfig withGracefulShutdownIgnoreSessions(boolean gracefulShutdownIgnoreSessions) {
   ...
   */
  @Override
  public NonClusteredServerConfig withGracefulShutdownWaitForSessions(boolean gracefulShutdownWaitForSessions) {

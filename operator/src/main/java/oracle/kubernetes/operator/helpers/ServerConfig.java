...
public class ServerConfig {
   ...
   * Legal values are RUNNING and ADMIN.
   ...
   * If a running server's pod does not have this label,
   * then the operator needs to restart the server and attach this label to it.
   ...
   * If specified, this value must be an unused port.
   * By default, the server will not be exposed outside the Kubernetes cluster.
   * @return node port
   */
   ...
   * If not specified, then the environment variables in config.xml will be used instead.
   * @return env
   */
  ...
  /**
   * Gets the list of references to secrets in the same namespace to use for pulling
  ...
  /**
   * Sets the list of references to secrets in the same namespace to use for pulling
   * the WebLogic Docker image.
   ...
   * Legal values are GRACEFUL_SHUTDOWN and FORCED_SHUTDOWN.
  ...
  /**
   * Gets the number of seconds to wait before aborting inflight work and
   * force shutting down the server.
   * Only used when shutdownPolicy is GRACEFUL_SHUTDOWN.
  ...
  /**
   * Sets the number of seconds to wait before aborting inflight work and
   * force shutting down the server.
  ...
  /**
   * Gets whether to ignore pending HTTP sessions during inflight work handling
   * when gracefully shutting down this server.
  ...
  /**
   * Sets whether to ignore pending HTTP sessions during inflight work handling
   * when gracefully shutting down this server.
  ...
  /**
   * Gets whether to wait for all HTTP sessions during inflight work handling
   * when gracefully shutting down this server.
  ...
  /**
   * Sets whether to wait for all HTTP sessions during inflight work handling
   * when gracefully shutting down this server.
  ...
  public int hashCode() {
    return new HashCodeBuilder()
      ...
      .append(nodePort).append(shutdownPolicy)
      .toHashCode();
  }

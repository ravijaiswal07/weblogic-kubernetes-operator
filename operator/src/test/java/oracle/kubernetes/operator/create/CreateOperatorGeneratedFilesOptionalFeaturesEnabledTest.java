 ...
 * creates are correct when all optional features are enabled:
 *   external rest self signed cert
 *   remote debug port enabled
 *   elk enabled
 *   haveimage pull secret
 */
public class CreateOperatorGeneratedFilesOptionalFeaturesEnabledTest extends CreateOperatorGeneratedFilesBaseTest {

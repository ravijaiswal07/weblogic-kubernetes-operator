...
public abstract class CreateDomainGeneratedFilesBaseTest {
  ...
  private static final String PROPERTY_CREATE_DOMAIN_NODE_MANAGER_PY =
      "create-domain-node-manager.py";
                                    ...
                                    newVolume()
                                        ...
                                        .configMap(
                                            newConfigMapVolumeSource()
                                                .name(
                                                    getInputs().getDomainUID()
                                                        + "-create-weblogic-domain-job-wdt-cm")
                                                .defaultMode(493)))
                                .addVolumesItem(
                                    newVolume()
                                        .name("weblogic-domain-storage-volume")
  ...
  public void generatesCorrect_createWeblogicDomainConfigMap() throws Exception {
    ...
    String actualCreateDomainNodeManagerPy =
        getThenEmptyConfigMapDataValue(actual, PROPERTY_CREATE_DOMAIN_NODE_MANAGER_PY);
  ...
  protected void assertThatActualCreateDomainNodeManagerPyIsCorrect(
      String actualReadDomainSecretPy) {

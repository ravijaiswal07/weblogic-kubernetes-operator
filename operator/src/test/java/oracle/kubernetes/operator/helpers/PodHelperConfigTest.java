...
public class PodHelperConfigTest {
  ...
  private V1Pod getActualManagedServerPodConfigForDefaults() throws Exception {
    return
      getActualManagedServerPodConfig(
        getDomainCustomResourceForDefaults(null, null), // default image & image pull policy
        newEmptyPersistentVolumeClaimList());
  }

  @Test
  public void computedAdminServerPodConfigForCustomLatestImageAndDefaults_isCorrect() throws Exception {
    assertThat(
  ...
  private V1Pod getActualAdminServerPodConfigForCustomLatestImageAndDefaults() throws Exception {
    return
      getActualAdminServerPodConfig(
        getDomainCustomResourceForDefaults(CUSTOM_LATEST_IMAGE, null), // custom latest image & default image pull policy
        newEmptyPersistentVolumeClaimList());
  }

  @Test
  public void computedManagedServerPodConfigForCustomLatestImageAndDefaults_isCorrect() throws Exception {
    assertThat(
  ...
  @Test
  public void computedAdminServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults_isCorrect() throws Exception {
    assertThat(
      getActualAdminServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults(),
      yamlEqualTo(getDesiredAdminServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults()));
  }

  private V1Pod getDesiredAdminServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults() {
    return getDesiredAdminServerPodConfigForDefaults(CUSTOM_LATEST_IMAGE, IFNOTPRESENT_IMAGEPULLPOLICY);
  }

  private V1Pod getActualAdminServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults() throws Exception {
    return
      getActualAdminServerPodConfig(
        getDomainCustomResourceForDefaults(CUSTOM_LATEST_IMAGE, IFNOTPRESENT_IMAGEPULLPOLICY), // custom latest image & custom image pull policy
        newEmptyPersistentVolumeClaimList());
  }

  @Test
  public void computedManagedServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults_isCorrect() throws Exception {
    assertThat(
      getActualManagedServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults(),
      yamlEqualTo(getDesiredManagedServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults()));
  }

  private V1Pod getDesiredManagedServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults() {
    return getDesiredManagedServerPodConfigForDefaults(CUSTOM_LATEST_IMAGE, IFNOTPRESENT_IMAGEPULLPOLICY);
  }

  private V1Pod getActualManagedServerPodConfigForCustomLatestImageAndCustomImagePullPolicyAndDefaults() throws Exception {
    return
      getActualManagedServerPodConfig(
        getDomainCustomResourceForDefaults(CUSTOM_LATEST_IMAGE, IFNOTPRESENT_IMAGEPULLPOLICY), // custom latest image & custom image pull policy
        newEmptyPersistentVolumeClaimList());
  ...
  @Test
  public void computedAdminServerPodConfigForPersistentVolumeClaimAndDefaults_isCorrect() throws Exception {
    assertThat(
  ...
  private V1Pod getActualAdminServerPodConfigForPersistentVolumeClaimAndDefaults() throws Exception {
    return
      getActualAdminServerPodConfig(
  ...
  @Test
  public void computedManagedServerPodConfigForPersistentVolumeClaimAndDefaults_isCorrect() throws Exception {
    assertThat(
  ...
  private V1Pod getActualManagedServerPodConfigForPersistentVolumeClaimAndDefaults() throws Exception {
    return
      getActualManagedServerPodConfig(
        getDomainCustomResourceForDefaults(null, null), // default image & default image pull policy
        newPersistentVolumeClaimListForPersistentVolumeClaim());
  ...
  private V1Pod getDesiredAdminServerPodConfigForServerStartupAndDefaults() {
    ...
    pod.getSpec().getContainers().get(0).getEnv().add(0, newEnvVar()
      .name(ADMIN_OPTION2_NAME)
      .value(ADMIN_OPTION2_VALUE));
    pod.getSpec().getContainers().get(0).getEnv().add(0, newEnvVar()
      .name(ADMIN_OPTION1_NAME)
      .value(ADMIN_OPTION1_VALUE));
    return pod;
  }

  private V1Pod getActualAdminServerPodConfigForServerStartupAndDefaults() throws Exception {
    Domain domain = getDomainCustomResourceForDefaults(null, null); // default image & default image pull policy
  ...
  private V1Pod getActualAdminServerPodConfig(Domain domain, V1PersistentVolumeClaimList claims) throws Exception {
  ...
  private static class TestAdminPodStep extends PodHelper.AdminPodStep {
    ...
    public V1Pod computeAdminPodConfig(Domain domain, V1PersistentVolumeClaimList claims) throws Exception {
  ...
  private static class TestManagedPodStep extends PodHelper.ManagedPodStep {
    ...
    public V1Pod computeManagedPodConfig(Domain domain, V1PersistentVolumeClaimList claims) throws Exception {
      Packet packet = newPacket(domain, claims);
      packet.put(
  ...
  private V1PersistentVolumeClaimList newPersistentVolumeClaimListForPersistentVolumeClaim() {
    return
      newPersistentVolumeClaimList()
        .addItemsItem(newPersistentVolumeClaim()
          .metadata(newObjectMeta()
            .name(WEBLOGIC_DOMAIN_PERSISTENT_VOLUME_CLAIM_NAME)));
  }
    ...
    return
      newServerStartupList()
        ...
        .addElement(newServerStartup()
          ...
          .withEnv(newEnvVarList()
            .addElement(newEnvVar()
              .name(MANAGED_OPTION3_NAME)
              .value(MANAGED_OPTION3_VALUE))
            .addElement(newEnvVar()
              .name(MANAGED_OPTION4_NAME)
  ...
  private V1Pod getDesiredBaseServerPodConfigForDefaults(String image, String imagePullPolicy, String serverName, int port) {

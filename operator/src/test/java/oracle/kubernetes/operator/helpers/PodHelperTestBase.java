...
public abstract class PodHelperTestBase {
  ...
  static final String LATEST_IMAGE = "image:latest";
  ...
  static final String DOMAIN_HOME = "/shared/domain/domain1";
  ...
  protected RetryStrategyStub retryStrategy = createStrictStub(RetryStrategyStub.class);
  ...
  protected V1EnvVar envItem(String name, String value) {
    return new V1EnvVar().name(name).value(value);
  }

  V1Lifecycle createLifecycle() {

 ...
 * 
 */
public class NonClusteredServer
    extends Server
{
     ...
     * @return this
     */
    public NonClusteredServer withNonClusteredServerStartPolicy(String nonClusteredServerStartPolicy) {
        this.nonClusteredServerStartPolicy = nonClusteredServerStartPolicy;
        return this;
    }
     ...
     */
    @Override
    public NonClusteredServer withImagePullSecrets(String imagePullSecrets) {
     ...
     */
    @Override
    public NonClusteredServer withGracefulShutdownIgnoreSessions(Boolean gracefulShutdownIgnoreSessions) {
     ...
     */
    @Override
    public NonClusteredServer withGracefulShutdownWaitForSessions(Boolean gracefulShutdownWaitForSessions) {
    ...
    public String toString() {
        return new ToStringBuilder(this).appendSuper(super.toString()).append("nonClusteredServerStartPolicy", nonClusteredServerStartPolicy).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(nonClusteredServerStartPolicy).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(nonClusteredServerStartPolicy, rhs.nonClusteredServerStartPolicy).isEquals();
    }

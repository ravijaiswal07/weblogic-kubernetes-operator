    ...
    extends Server
{
     ...
     */
    @Override
    public ClusteredServer withGracefulShutdownIgnoreSessions(Boolean gracefulShutdownIgnoreSessions) {
     ...
     */
    @Override
    public ClusteredServer withGracefulShutdownWaitForSessions(Boolean gracefulShutdownWaitForSessions) {
    ...
    public String toString() {
        return new ToStringBuilder(this).appendSuper(super.toString()).append("clusteredServerStartPolicy", clusteredServerStartPolicy).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(clusteredServerStartPolicy).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(clusteredServerStartPolicy, rhs.clusteredServerStartPolicy).isEquals();
    }
